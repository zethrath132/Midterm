...
//Ben's Change Log:  Added a *KILL_COUNT to the walking speed, run speed, stamina thresh hold, and stamina recovery
...
idCVar pm_jumpheight(				"pm_jumpheight",			"48*KILL_COUNT",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "approximate hieght the player can jump" );
...
idCVar pm_crouchspeed(				"pm_crouchspeed",			"80*KILL_COUNT",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "speed the player can move while crouched" );
// RAVEN BEGIN
idCVar pm_speed(					"pm_speed",					"160*KILL_COUNT",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "speed the player can move while running" );
idCVar pm_walkspeed(				"pm_walkspeed",				"80*KILL_COUNT",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "speed the player can move while walking" );
// RAVEN END
...
idCVar pm_stamina(					"pm_stamina",				"24*KILL_COUNT",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "length of time player can run" );
...
idCVar pm_staminarate(				"pm_staminarate",			"0.75*KILL_COUNT",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "rate that player regains stamina. divide pm_stamina by this value to determine how long it takes to fully recharge." );
